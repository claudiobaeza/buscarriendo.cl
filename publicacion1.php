...
<header>         
		...
		<nav id="barra"  style="background-color: rgba(156, 217, 107, 0.6)">
...
<div style="width:50%; margin:0 auto; border-radius: 10px 10px; box-shadow: 2px 2px 5px #D2691E; opacity: 0.8;" class="fondo-granada alinear-centro">
